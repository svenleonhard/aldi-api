...
public class OpenApiConfiguration {
    ...
    public SwaggerCustomizer noApiFirstCustomizer() {
        return docket -> docket.select()
            .apis(Predicates.not(RequestHandlerSelectors.basePackage("de.offersapp.aldiapi.web.api")));
    }
    ...
    public Docket apiFirstDocket(JHipsterProperties jHipsterProperties) {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .select()
            .apis(RequestHandlerSelectors.basePackage("de.offersapp.aldiapi.web.api"))
