package de.offersapp.aldiapi.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("AldiApi");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("AldiApi");
        ...
        config.getMapConfigs().put("de.offersapp.aldiapi.domain.*", initializeDomainMapConfig(jHipsterProperties));
